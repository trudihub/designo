import { Headline, Paragraph, Button, FooterStyle } from "./StyledComponents"
    ...
    return (
        <FooterStyle>
            <div id="contactFooter">
                <Headline>Let's talk about our project</Headline>
                <Paragraph>Ready to take it to the next level? Contact us today and find out how our expertise can help your business grow.</Paragraph>
                <Link to="/contact">
            ...
            <p>3886 Wellington St</p>
            <p>Toronto, Ontario</p>
            </div>
            <div>
                <h5>Contact Us (Central Office)</h5>
                <p>P:+6348927234</p>
                <p>M: contactus@dasd.com</p>
            </div>
            <div>
